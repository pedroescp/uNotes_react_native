...
export default function EditCategoria({ open, setOpen, categoriaID, onClose, title }: any) {
    ...
    const updateCategoria = async () => {
        ...
        if (title != inputModal) {
            try {
                const response = await api.editCategoria({
                    "id": categoriaID,
                    "titulo": inputModal,
                    "categoriaPai": null
                })
            ...
            <View style={styles.centeredView}>
                <View style={styles.modalView}>
                    ...
                    <View style={{ display: "flex", alignItems: "flex-start", width: "100%", flexDirection: "row", justifyContent: "space-between" }}>
                        ...
                        <TouchableOpacity style={styles.button} activeOpacity={0.7} onPress={() => updateCategoria()} >
